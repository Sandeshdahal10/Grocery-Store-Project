 ...
 * MainBanner
 *
 * Functional React component that renders the homepage hero/banner.
 *
 * Behavior:
 * - Displays responsive background images (desktop and mobile) from `assets`.
 * - Shows a headline and two CTAs that link to the products page.
 * - Uses react-router `Link` for client-side navigation.
 *
 * Props: none (reads assets directly).
 *
 * Returns: JSX element containing the banner layout and CTA buttons.
 */
const MainBanner = () => {
  return (
